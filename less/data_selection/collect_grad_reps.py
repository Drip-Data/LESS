...
def obtain_gradients_with_adam(model, batch, avg, avg_sq, accelerator):
...
def collect_grads(dataloader,
    ...
    for batch in tqdm(dataloader, total=len(dataloader)):
        ...
        if gradient_type == "adam":
            ...
            vectorized_grads = obtain_gradients_with_adam(model, batch, m, v, accelerator)
